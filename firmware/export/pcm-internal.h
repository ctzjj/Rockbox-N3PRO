...
/* Backend hook: the real rate of a fixed-rate output (e.g. bluetooth,
 * which is configured once at open and cannot be reconfigured later).
 * Non-zero means "clamp rate changes to this rate"; 0 means the output
 * follows the requested rate. */
